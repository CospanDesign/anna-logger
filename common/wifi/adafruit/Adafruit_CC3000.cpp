...
{
  const uint32_t intervalTime[16] = { 2000, 2000, 2000, 2000,  2000,
...
bool Adafruit_CC3000::startSmartConfig(const char *_deviceName, const char *smartConfigKey)
{
  ...
  if (enableAES)
  {
    ...
    CHECK_SUCCESS(aes_write_key((uint8_t *)(smartConfigKey)),
...
//
//*****************************************************************************
void CC3000_UsynchCallback(long lEventType, char * data, uint8_t length)
{
