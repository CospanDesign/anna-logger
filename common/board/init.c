...
struct spi_master_vec_module anna_wifi_master;
...
void configure_anna_wifi_spi( void )
{
    ...
    spi_config.pinmux_pad2 = ANNA_WIFI_SPI_SERCOM_PINMUX_PAD2;
    spi_config.pinmux_pad3 = ANNA_WIFI_SPI_SERCOM_PINMUX_PAD3;
    spi_master_vec_init(&anna_wifi_master, ANNA_WIFI_SPI_MODULE, &spi_config);
}
/*
