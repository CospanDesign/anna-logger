...
void configure_anna_sdmicro_spi( void )
{
	...
	config_spi.pinmux_pad1 = ANNA_SDMICRO_SPI_SERCOM_PINMUX_PAD2;
...
void configure_anna_wifi_spi( void )
{
	...
	config_spi.pinmux_pad1 = ANNA_WIFI_SPI_SERCOM_PINMUX_PAD2;
...
void configure_anna_card_spi( void )
{
	...
	config_spi.pinmux_pad1 = ANNA_CARD_SPI_SERCOM_PINMUX_PAD2;
